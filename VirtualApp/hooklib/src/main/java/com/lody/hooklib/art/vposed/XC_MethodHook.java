...
import com.lody.hooklib.art.vposed.callbacks.IXUnhook;
import com.lody.hooklib.art.vposed.callbacks.XCallback;
...
public abstract class XC_MethodHook extends XCallback {
	...
	public class Unhook implements IXUnhook {
		...
		@Override
		public void unhook() {
			VposedBridge.unhookMethod(hookMethod, XC_MethodHook.this);
		}
