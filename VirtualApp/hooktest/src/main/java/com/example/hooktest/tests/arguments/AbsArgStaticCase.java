...
public abstract class AbsArgStaticCase extends TestCase {
    ...
    @Override
    public void test() {
        VposedBridge.hookMethod(getTargetMethod(), new LogMethodHook() {
            @Override
    ...
    protected Method getTargetMethod() {
        ...
        Method method = VposedHelpers.findMethodExact(ArgumentTarget.class, methodName, getParamsSignature());
