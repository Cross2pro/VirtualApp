...
public class Case2 implements Case{
    ...
    @Override
    public void hook() {
//        VposedBridge.findAndHookMethod(Target.class, "add", int.class, int.class, new XC_MethodHook() {
//            @Override
...
//        });
//
//        VposedBridge.findAndHookMethod(Target.class, "test4", int.class, new XC_MethodHook() {
//            @Override
//            protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
//                super.beforeHookedMethod(param);
